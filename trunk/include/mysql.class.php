<?php
// TODO: interface for SQL logging

/**
 * MySQL - MySQL PHP Object Class
 * it's recommented to use this with php 4.2.x and mysql 4.0.x
 * it has been also tested with php 5.0.1 and mysql
 *
 * @version 3.4.0 - 2005-06-08
...
Copyright (C) 2004 Christoph Becker <cbecker@nachtwach.de>
 ...
 * @copyright Copyright (c) 2004-11-01
 * @version 3.3.1
 * @access public
 */
...
int
	...
	{
		return $this->init ( $SERVER , $USER , $PASS , $DBASE , $DBG );
	}
